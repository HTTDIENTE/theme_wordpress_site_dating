...
abstract class ParticipantOptions {
	...
	public static function create(
		...
		return new CreateParticipantOptions( $statusCallback, $statusCallbackMethod, $statusCallbackEvent, $label,
			$timeout, $record, $muted, $beep, $startConferenceOnEnter, $endConferenceOnExit, $waitUrl, $waitMethod,
			$earlyMedia, $maxParticipants, $conferenceRecord, $conferenceTrim, $conferenceStatusCallback,
			...
			$conferenceRecordingStatusCallbackEvent, $coaching, $callSidToCoach, $jitterBufferSize, $byoc, $callerId,
			$callReason, $recordingTrack, $timeLimit );
	}
...
class CreateParticipantOptions extends Options {
	 ...
	 * @return $this Fluent Builder
	 */
	public function setConferenceRecordingStatusCallbackMethod( string $conferenceRecordingStatusCallbackMethod
	): self {
		$this->options['conferenceRecordingStatusCallbackMethod'] = $conferenceRecordingStatusCallbackMethod;
