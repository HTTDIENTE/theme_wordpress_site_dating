...
class InteractionChannelParticipantList extends ListResource {
	 ...
	 * @param array $mediaProperties JSON representing the Media Properties for the
	 *                               new Participant.
	 *
	 * @return InteractionChannelParticipantInstance Created
	...
	public function create( string $type, array $mediaProperties ): InteractionChannelParticipantInstance {
		$data = Values::of( [ 'Type' => $type, 'MediaProperties' => Serialize::jsonObject( $mediaProperties ), ] );
	...
	/**
	 * Streams InteractionChannelParticipantInstance records from the API as a
	 * generator stream.
	...
	/**
	 * Retrieve a single page of InteractionChannelParticipantInstance records from
	 * the API.
	 ...
	 *
	 * @return InteractionChannelParticipantPage Page of
	 *                                           InteractionChannelParticipantInstance
	 */
	...
	/**
	 * Retrieve a specific page of InteractionChannelParticipantInstance records
	 * from the API.
	 * Request is executed immediately
	 *
