...
class InteractionChannelInviteList extends ListResource {
	...
	public function create( array $routing ): InteractionChannelInviteInstance {
		$data = Values::of( [ 'Routing' => Serialize::jsonObject( $routing ), ] );
	...
	/**
	 * Streams InteractionChannelInviteInstance records from the API as a generator
	 * stream.
	...
	/**
	 * Retrieve a single page of InteractionChannelInviteInstance records from the
	 * API.
	...
	/**
	 * Retrieve a specific page of InteractionChannelInviteInstance records from
	 * the API.
	 * Request is executed immediately
	 *
