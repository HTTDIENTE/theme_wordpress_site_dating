...
abstract class ServiceOptions {
	...
	public static function create(
		...
		return new CreateServiceOptions( $codeLength, $lookupEnabled, $skipSmsToLandlines, $dtmfInputRequired, $ttsName,
			$psd2Enabled, $doNotShareWarningEnabled, $customCodeEnabled, $pushIncludeDate, $pushApnCredentialSid,
			$pushFcmCredentialSid, $totpIssuer, $totpTimeStep, $totpCodeLength, $totpSkew, $defaultTemplateSid );
	}
	...
	public static function update(
		...
		return new UpdateServiceOptions( $friendlyName, $codeLength, $lookupEnabled, $skipSmsToLandlines,
			$dtmfInputRequired, $ttsName, $psd2Enabled, $doNotShareWarningEnabled, $customCodeEnabled, $pushIncludeDate,
			$pushApnCredentialSid, $pushFcmCredentialSid, $totpIssuer, $totpTimeStep, $totpCodeLength, $totpSkew,
			$defaultTemplateSid );
	}
}
