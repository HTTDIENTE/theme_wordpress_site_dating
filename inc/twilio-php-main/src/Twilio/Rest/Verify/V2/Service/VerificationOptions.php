...
abstract class VerificationOptions {
	...
	public static function create(
		...
		return new CreateVerificationOptions( $customFriendlyName, $customMessage, $sendDigits, $locale, $customCode,
			$amount, $payee, $rateLimits, $channelConfiguration, $appHash, $templateSid, $templateCustomSubstitutions );
	}
}
