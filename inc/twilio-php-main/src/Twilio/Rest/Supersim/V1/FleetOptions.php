...
abstract class FleetOptions {
	...
	public static function create(
		...
		return new CreateFleetOptions( $uniqueName, $dataEnabled, $dataLimit, $ipCommandsUrl, $ipCommandsMethod,
			$smsCommandsEnabled, $smsCommandsUrl, $smsCommandsMethod );
	}
	...
	public static function update(
		...
		return new UpdateFleetOptions( $uniqueName, $networkAccessProfile, $ipCommandsUrl, $ipCommandsMethod,
			$smsCommandsUrl, $smsCommandsMethod, $dataLimit );
	}
}
