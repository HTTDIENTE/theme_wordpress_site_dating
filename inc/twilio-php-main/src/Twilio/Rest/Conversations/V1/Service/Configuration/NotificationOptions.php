...
abstract class NotificationOptions {
	...
	public static function update(
		...
		return new UpdateNotificationOptions( $logEnabled, $newMessageEnabled, $newMessageTemplate, $newMessageSound,
			$newMessageBadgeCountEnabled, $addedToConversationEnabled, $addedToConversationTemplate,
			$addedToConversationSound, $removedFromConversationEnabled, $removedFromConversationTemplate,
			$removedFromConversationSound, $newMessageWithMediaEnabled, $newMessageWithMediaTemplate );
	}
}
