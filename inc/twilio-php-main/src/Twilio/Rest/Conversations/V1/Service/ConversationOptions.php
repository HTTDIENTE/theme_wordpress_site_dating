...
abstract class ConversationOptions {
	...
	public static function create(
		...
		return new CreateConversationOptions( $friendlyName, $uniqueName, $attributes, $messagingServiceSid,
			$dateCreated, $dateUpdated, $state, $timersInactive, $timersClosed, $xTwilioWebhookEnabled );
	}
