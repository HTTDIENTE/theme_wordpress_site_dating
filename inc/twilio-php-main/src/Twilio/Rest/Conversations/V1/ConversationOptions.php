...
abstract class ConversationOptions {
	...
	public static function create(
		...
		return new CreateConversationOptions( $friendlyName, $uniqueName, $dateCreated, $dateUpdated,
			$messagingServiceSid, $attributes, $state, $timersInactive, $timersClosed, $xTwilioWebhookEnabled );
	}
	...
	public static function update(
		...
		return new UpdateConversationOptions( $friendlyName, $dateCreated, $dateUpdated, $attributes,
			$messagingServiceSid, $state, $timersInactive, $timersClosed, $uniqueName, $xTwilioWebhookEnabled );
	}
