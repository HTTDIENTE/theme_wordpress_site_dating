...
abstract class ByocTrunkOptions {
	...
	public static function create(
		...
		return new CreateByocTrunkOptions( $friendlyName, $voiceUrl, $voiceMethod, $voiceFallbackUrl,
			$voiceFallbackMethod, $statusCallbackUrl, $statusCallbackMethod, $cnamLookupEnabled, $connectionPolicySid,
			$fromDomainSid );
	}
	...
	public static function update(
		...
		return new UpdateByocTrunkOptions( $friendlyName, $voiceUrl, $voiceMethod, $voiceFallbackUrl,
			$voiceFallbackMethod, $statusCallbackUrl, $statusCallbackMethod, $cnamLookupEnabled, $connectionPolicySid,
			$fromDomainSid );
	}
}
