<?php
$get_preference_data = WLD_Account_Matches::get_match_preference_data();
?>
<section id="section-filter-matches" style="display: none">
		...
		<div class="personal-information">
			...
			<div class="form-row">
				<select id="body-type-select-1">
					<option
						value="" <?php echo empty( $get_preference_data['body_type'] ) ? 'selected="selected"' : ''; ?>
						disabled="">Body Type
					</option>
					<?php
			...
			<div class="form-row">
				<select id="ethnicity-select-1">
					...
					?>
					<option
						value="" <?php echo empty( $get_preference_data['ethnicity'] ) ? 'selected="selected"' : ''; ?>
						disabled="">Ethnicity
					</option>
					<?php
		...
		<div class="life-style">
			...
			<div class="form-row">
				<select id="want-kids-1">
					<option
						value="" <?php echo empty( $get_preference_data['want_kids'] ) ? 'selected="selected"' : ''; ?>
